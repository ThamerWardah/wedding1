...
export default function RSVPModal({ 
  ...
  useEffect(() => {
    ...
    if (guestName) {
      ...
      setName(''); // Reset name if no guestName provided
    }
  ...
  const handleSubmit = async (e) => {
    ...
    // Fixed validation: check for either guestName or user-entered name
    ...
    try {
      const rsvpData = {
        name: guestName || name, // Use guestName if available, otherwise user input
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileHover={(!isSubmitting && (guestName || name.trim()) && attending) ? { scale: 1.02 } : {}}
                      whileTap={(!isSubmitting && (guestName || name.trim()) && attending) ? { scale: 0.98 } : {}}
